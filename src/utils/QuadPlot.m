classdef QuadPlot < handle
    ...
    properties (SetAccess = public)
        ...
        time = 0;       % time
        state;          % state
        des_state;      % desired state [x; y; z; xdot; ydot; zdot];
    ...
    methods
        ...
        function Q = QuadPlot(qn, state, wingspan, height, color, max_iter, h_3d)
            ...
            Q.point = [0; 0; 0];  % Initialize point position
            ...
            Q.h_point = plot3(Q.h_3d, Q.point(1), Q.point(2), Q.point(3), 'go', 'MarkerSize', 10);
        ...
        % Update quad plot
        function UpdateQuadPlot(Q, state, des_state, time, point)
